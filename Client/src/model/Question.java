...
public class Question implements Serializable {
	...
	public Question(int id, String question_textl, int answer_1_id, int answer_2_id, int answer_3_id, int answer_4_id,
			int answer_5_id, int answer_6_id) {
		super();
		this.id = id;
		this.question_text = question_textl;
	...
	public Question(String question_textl, int answer_1_id, int answer_2_id, int answer_3_id, int answer_4_id,
			int answer_5_id, int answer_6_id) {
		super();
		this.question_text = question_textl;
		this.answer_1_id = answer_1_id;
	...
	public void setQuestion_text(String question_textl) {
		this.question_text = question_textl;
	}
